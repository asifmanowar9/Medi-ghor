...
export const BANNER_ADMIN_LIST_REQUEST = 'BANNER_ADMIN_LIST_REQUEST';
export const BANNER_ADMIN_LIST_SUCCESS = 'BANNER_ADMIN_LIST_SUCCESS';
export const BANNER_ADMIN_LIST_FAIL = 'BANNER_ADMIN_LIST_FAIL';
